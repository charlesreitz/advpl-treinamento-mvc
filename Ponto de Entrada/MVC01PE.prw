...
User Function U_MVC01()
	...
	If aParam <> NIL
		...
		If     cIdPonto ==  'MODELPOS'
			...
			EndIf
			// oModelZ00 := oObj:GetModel("Z00MASTER")
			// oModelZ00:GetValue("Z00_NOME")
			// oModelZ00:SetValue("Z00_NOME", "Nome do Produto")
			// oModelZ00:LoadValue("Z00_NOME", "Nome do Produto")

			// nLine := oModelZ00:Length()
			// For  nI := 1 To nLine
			// 	oModelZA2:GoLine( nI )
			// 	oModelZ00:GetValue("Z00_NOME")
			// 	oModelZ00:SetValue("Z00_NOME", "Nome do Produto")
